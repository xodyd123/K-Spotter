...
<div className="pointer-events-none fixed left-1/2 top-[max(env(safe-area-inset-top),1.25rem)] -translate-x-1/2 z-40 w-[min(92%,720px)] px-3 sm:px-4">
  <div
...
<div className="relative flex-1">
  {/* 아이콘: 입력창 안쪽에 겹치기 */}
  <SearchIcon
    className=" pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 z-10"
    strokeWidth={2}
    aria-hidden
  />

  {/* 입력창: 아이콘만큼 왼쪽 패딩 확보(pl-10 정도) */}
  <input
    id="q"
    value={inputs}
